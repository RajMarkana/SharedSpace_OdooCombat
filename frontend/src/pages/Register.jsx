...
const Register = () => {
  ...
  return (
    ...
    <div class=" h-full md:min-h-screen p-4">
      <div class="grid justify-center max-w-md mx-auto">
        <div>
          <img src="./signup.png" class="w-full object-cover rounded-2xl" width={300} alt="login-image" />
        </div>

        <form class="bg-white rounded-2xl p-6 -mt-24 relative z-10 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
          <div class="mb-12">
            <h3 class="text-3xl font-extrabold text-primary">Register</h3>
          </div>
